...
public class SuperMilho extends Comida {

    public SuperMilho(String nome, Quadricula posicao, Animation animacao, Jogo jogo, int pontos) {
        super(nome, posicao, animacao, jogo, pontos);
    }
